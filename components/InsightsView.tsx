...
function BreachTable({
  ...
  return (
    <GlassCard className="p-5">
      ...
      <div className="max-h-72 overflow-auto rounded-2xl border border-slate-200/60 dark:border-white/10">
        <table className="w-full min-w-[640px] text-left text-sm">
          <thead className="sticky top-0 bg-white/95 text-[10px] uppercase tracking-wider text-slate-500 backdrop-blur dark:bg-slate-950/90 dark:text-slate-400">
            <tr>
  ...
  return (
    <section className="space-y-4 rounded-3xl border border-cyan-400/20 bg-cyan-50/30 p-4 dark:border-cyan-400/15 dark:bg-cyan-500/[0.05] sm:p-5">
      ...
      {expanded ? (
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">Collapsed — expand to view SLA dashboards and out-of-SLA tickets.</p>
      )}
    </section>
  );
}
