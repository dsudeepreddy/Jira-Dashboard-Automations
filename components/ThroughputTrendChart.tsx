      ...
      <div className="h-72">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} barGap={6} margin={{ top: 8, right: 8, left: 4, bottom: 4 }}>
            ...
            <Bar dataKey="created" name="Opened" fill="url(#created-bar)" radius={[8, 8, 0, 0]} animationDuration={1200} />
            <Bar dataKey="resolved" name="Closed" fill="url(#resolved-bar)" radius={[8, 8, 0, 0]} animationDuration={1200} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </ChartPanel>
